...
our $http_config = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=10;
_EOC_
...
our $http_config_hard = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=11;
_EOC_
...
our $http_config_restart = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=12;
_EOC_
...
our $http_config_plain = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=13;
_EOC_
...
our $http_config_custom = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=14;
_EOC_
...
our $http_config_cache_tag = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=15;
_EOC_
...
our $http_config_multi_tag = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=0;
_EOC_
...
our $http_config_overload = <<'_EOC_';
    ...
    cache_pilot_index_store   redis 127.0.0.1:6380 db=1;
_EOC_
...
=== TEST 18: plain PURGE still works with redis cache_pilot_index
--- http_config eval: $::http_config_plain
--- config eval: $::config_plain
--- request
PURGE /proxy/plain
